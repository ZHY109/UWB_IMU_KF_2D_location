...
# svm建模
svm_classification =SVC(C=50000,coef0=0.0,degree=4,kernel='poly',probability=False)
#模型效果
...
#
# joblib.dump(model.best_estimator_, './models/left_uwb_bestSVC.pkl')
# model = joblib.load('./models/left_uwb_bestSVC.pkl')
# best {'C': 50000, 'coef0': 0.0, 'degree': 4, 'kernel': 'poly', 'probability': False}最好的score:  0.8628979591836735